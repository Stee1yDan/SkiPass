...
namespace SkiPass {
    ...
    void CLIView::show_account_info(TicketService::TicketInfo ticket_info) {
        std::cout << "Full Name " << ticket_info.username << std::endl;
        std::cout << "Gender " << ticket_info.gender << std::endl;
        std::cout << "Age " << ticket_info.age << std::endl;
        std::cout << "--------------------" <<  std::endl;
        std::cout << "Ticket Id " << ticket_info.ticket_type << std::endl;
        std::cout << "Ticket Type " << ticket_info.ticket_type << std::endl;
        std::cout << "Balance " << ticket_info.balance_unit<< std::endl;
    }
