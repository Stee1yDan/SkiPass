...
namespace SkiPass {
    ...
    public:
        ...
        virtual std::optional<std::shared_ptr<StorageUnit>> get_unit(StorageUnit::unit_id_t id) const = 0;
        virtual std::vector<std::shared_ptr<StorageUnit>> get_all() const = 0;

        virtual std::optional<std::shared_ptr<StorageUnit>>
